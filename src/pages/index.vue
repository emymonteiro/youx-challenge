...
export default {
  ...
  methods: {
    async updateMap(local) {
      const res = await axios.get(`patients?state=${local}`)
      this.selected.sigla = local
